...
import { Eye, EyeOff, Loader2, Mail, Sparkles, User } from 'lucide-react'
...
export default function RegisterForm() {
  const [state, action] = useFormState<ActionResult | null, FormData>(registerAction, null)
  ...
  return (
    <form action={action} className="space-y-4">
      <div className="space-y-1.5">
        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">ชื่อ</label>
